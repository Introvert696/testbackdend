...
final class PatientController extends AbstractController
{
    ...
    ): JsonResponse
    {
        ...
        $response = $this->responseFabric->getResponse(
            ...
            $this->adaptersService->convertPatientToPatientResponseDTO($validRequest)
        );
    ...
    ): JsonResponse
    {
        ...
        if ($chamberPatients) {
            ...
            $chamberPatients = $chambersPatientsService->createChamberPatients(
                $patient,
                $chamber
            );
        ...
        $response = $this->responseFabric->getResponse(
            ...
            $this->adaptersService->convertPatientToPatientResponseDTO($patient)
        );
    ...
    public function delete(int $id): JsonResponse
    {
        ...
        $this->em->remove($this->responseHelper->getFirstElement($patient));
        $this->em->flush();
        $response = $this->responseFabric->getResponse(
            ResponseFabric::RESPONSE_TYPE_OK,
